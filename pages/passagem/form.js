...
const form = () => {
    ...
    return (
        <>
            <Pagina titulo='Passagem' typeNavBar="usuario">
                ...
                <Form>
                    ...
                    <div style={{ height: 400, width: '100%', background: '#9400d3' }}>
                        <DataGrid 
        ...
        <AccordionSummary style={{background:'black'}}
          expandIcon={<ExpandMoreIcon style={{color:'#4300d2'}}/>}
          aria-controls="panel1a-content"
          id="panel1a-header"
        >
          <Typography style={{color:'#4300d2'}}>Como Escolher seu assento?</Typography>
        </AccordionSummary>
        <AccordionDetails style={{background:'gray'}}>
          <Typography style={{color: '#00f3fc'}}>
            O assento deve ser escolhido da seguinte forma: Inicialmente escolha um numero entre 0-9,
            depois escolha uma letra entre A-F, exemplos: 0A, 3D, 8F.
          </Typography>
        </AccordionDetails>
      </Accordion>
